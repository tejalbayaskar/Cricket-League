...
<tr><td><input type="text" name="pname" placeholder="Player's Name"/></td></tr><br>
<tr><td><label for="ppic">Please upload a player picture:</label>
    <input type="file" name="ppic" id="ppic" ></td></tr>
<!--tr><td><input type="text" name="countryname" placeholder="Country"/></td></tr--><br>

<tr><td>Date of birth:<input type="date" name="dob" placeholder="Date of birth"  /></td></tr><br>
<tr><td>playing Role:<input type="text" name="role" placeholder="playing Role" /></td></tr><br>
<tr><td>Batting Style:<input type="text" name="batstyle" placeholder="Batting Style"  /></td></tr><br>
<tr><td>Bowling Style:<input type="text" name="bstyle" placeholder="Bowling Style" /></td></tr><br>

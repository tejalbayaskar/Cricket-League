<?php
 // Constructor to the db
  ...
  $cursor = $db-> posts ->find();
	...
	//$comment = $db-> posts ->findOne(array('_id' => $id));
      ...
      <div class="col-lg-8">
           <?php if (!empty($article['comments'])): ?>
                ...
                <?php foreach($article['comments'] as $comment):
                    ...
                    <col-lg-><?php echo date('g:i a, F j', $comment['posted_at']->sec); ?></col-lg-><br/>
                <?php endforeach;
            endif;?>
<!-- 
          ...
          <form method="post" action="comment.php">
              ...
              <input type="hidden" name="article_id" value="<?phpecho $article[]; ?>"/><br>
